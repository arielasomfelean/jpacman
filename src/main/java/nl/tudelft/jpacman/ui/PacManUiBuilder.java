...
public class PacManUiBuilder {
     ...
     */
    private PanelFormatter scoreFormatter,livesFormatter = null;
     ...
     * @return The builder.
     */
    public PacManUiBuilder withScoreFormatter(PanelFormatter scoreFormatter) {
        this.scoreFormatter = scoreFormatter;
        return this;
    }
    public PacManUiBuilder withLivesFormatter(PanelFormatter livesFormatter) {
